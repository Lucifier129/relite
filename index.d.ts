 ...
 */
export declare type Action<S extends object, P = unknown> = AnyAction<S, P, S>;
/**
 * Curring Action
 *
 ...
 */
export declare type StateFromAction<A> = A extends AnyAction ? unknown extends ReturnType<A> ? {} : ReturnType<A> extends object ? ReturnType<A> : {} : {};
/**
 ...
 */
export declare type UnionStateFromAS<AS> = {
 ...
 * @template AS The input `Actions` type
 */
export declare type StateFromAS<AS> = UnionToIntersection<UnionStateFromAS<AS>>;
/**
 * The collection of `Action`.
 *
 * @template S The type of state to be held by the store.
 */
export declare type Actions<S extends object> = {
 ...
 */
export declare type Curring<S extends object, A extends AnyAction<S>> = A extends ((state: S, ...args: infer Args) => infer Result) ? ((...args: Args) => Result) : never;
/**
 ...
 * that store will export.
 */
export declare type Currings<S extends object, AS extends Actions<S & StateFromAS<AS>>> = {
 ...
 */
export declare type PayloadFromAction<A> = A extends Action<object, infer P> ? P : A;
/** Data */
/**
...
export interface StoreCreator {
    <S extends object, AS extends Actions<S & StateFromAS<AS>>>(actions: AS, initialState?: S): Store<S & StateFromAS<AS>, AS>;
}
/** CreateStore */
/**
 ...
 */
export declare const createStore: StoreCreator;
