...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _relite = __webpack_require__(328);
	...
	var store = (0, _relite.createStore)(actions, initialState);
	...
	function render() {
		_reactDom2.default.render(_react2.default.createElement(_Counter2.default, _extends({}, store.getState(), store.actions)), document.getElementById('container'));
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _createStore = __webpack_require__(329);

	var _createStore2 = _interopRequireDefault(_createStore);

	var _createLogger = __webpack_require__(331);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function createStore(actions, initialState) {
	    ...
	    var dispatch = function dispatch(actionType, actionPayload) {
	        ...
	        try {
	            isDispatching = true;
	            nextState = actions[actionType].apply(actions, [currentState].concat(_toConsumableArray(Object.values(actionPayload))));
	        } catch (error) {
	            throw error;
	        } finally {
	            isDispatching = false;
	        ...
	        var updateState = function updateState(nextState) {
	            if (_.isFn(nextState)) {
	                return updateState(nextState.apply(undefined, [currentState].concat(_toConsumableArray(Object.values(actionPayload)))));
	            }
...
/***/ (function(module, exports) {
	...
	var INCREMENT = exports.INCREMENT = function INCREMENT(state, a, b, c) {
	...
	var INCREMENT_ASYNC = exports.INCREMENT_ASYNC = function () {
	        ...
	        return regeneratorRuntime.wrap(function _callee$(_context) {
	            while (1) {
	                switch (_context.prev = _context.next) {
	                    ...
	                    case 2:
	                        return _context.abrupt("return", INCREMENT);
	    ...
	    return function INCREMENT_ASYNC(_x) {
	...
	var EXEC = exports.EXEC = function EXEC(state) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function Counter(props) {
		var count = props.count,
		    ...
		    INCREMENT_IF_ODD = props.INCREMENT_IF_ODD,
		    INCREMENT_ASYNC = props.INCREMENT_ASYNC,
		    EXEC = props.EXEC,
		    CHANGE_INPUT = props.CHANGE_INPUT;
		...
		return _react2.default.createElement(
			...
			_react2.default.createElement(
				'button',
				{ onClick: INCREMENT.bind(this, 'aaa', 'bbb', { 'hello': 'world' }) },
				'+'
			),
			' ',
			_react2.default.createElement(
