...
exports.createStore = function (actions, initialState) {
    ...
    var subscribe = function (listener) {
        ...
        return function () {
            ...
            if (index !== -1) {
                ...
                console.warn("You want to unsubscribe a nonexistent listener. Maybe you had unsubscribed it");
            }
        };
    };
    ...
    var curryActions = Object.keys(actions).reduce(function (obj, actionType) {
        if (typeof actions[actionType] === "function") {
            obj[actionType] = function (actionPayload) { return dispatch(actionType, actionPayload); };
        }
        else {
            throw new Error("Action must be a function. accept " + actions[actionType]);
        }
        return obj;
    }, {});
    var store = {
